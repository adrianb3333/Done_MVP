...
export default function HandicapModal() {
  ...
  const previousHandicap = 14.5;
  const handicapTrend = currentHandicap < previousHandicap ? 'down' : 'up';
      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false} contentContainerStyle={styles.bodyContent}>
        <View style={styles.topSection}>
          <View style={styles.handicapRow}>
            <View style={styles.handicapNumberWrap}>
              <View style={styles.trendArrow}>
                {handicapTrend === 'down' ? (
                  <TrendingDown size={14} color="#2ECC40" />
                ) : (
            ...
            <Text style={styles.playerCurveLabel}>Player Curve</Text>
          </View>
        </View>
