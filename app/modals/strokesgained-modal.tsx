      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.placeholderSection}>
            <Text style={styles.placeholderTitle}>Strokes Gained Analysis</Text>
            <Text style={styles.placeholderDesc}>Sensor data will populate your strokes gained breakdown here.</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    </View>
